...
func TestAuthProcedure(t *testing.T) {
	rulesConfPath := flag.String("rulesconf", "cas_test/validator.json", "Auth server test config file path")

	// Load test config file
	confPath := flag.String("conf", "cas_test/obtainer.json", "Auth server test config file path")
	flag.Parse()
